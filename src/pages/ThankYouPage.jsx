...
const ThankYouPage = () => {
  return (
    <div>
      <Helmet>
        <title>Thank You for Your Order | 10X Energy Drink</title>
        <meta name="description" content="Thank you for purchasing 10X energy drinks. Your order has been received and is being processed. We appreciate your business." />
        <meta name="keywords" content="order confirmation, thank you, 10X purchase, order complete, energy drink order" />
      </Helmet>
      {/* 
        ---------------------------------------------------
      ...
      */}
      <div className="block md:hidden">
        ...
        >
          <h1 className="text-8xl quantico-bold-italic ">Thank <br/>You!</h1>
          <p className="text-xl text-black pt-sans-regular mt-4 ">
            We appreciate your purchase and look <br/>forward to serving you again.
          </p>
          {/* Bottom Buttons */}
        ...
        <div className="w-full">
          ...
          <div className="w-full  ">
            <img className="w-full h-auto" src={About10XTop} alt="About10XTop" />
            <img className="w-[300px] h-auto -mt-[120px]" src={About10XBottom} alt="About10XBottom" />
          </div>
        </div>
      </div>
    </div>
